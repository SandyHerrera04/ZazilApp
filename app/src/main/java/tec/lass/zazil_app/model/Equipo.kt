...
val integrantes = listOf(
    ...
    Integrante("Fernanda", "Ponce", "A01799293@tec.mx", R.drawable.fer),
    Integrante("Lorena", "Solís", "A01746602@tec.mx", R.drawable.lore),
    Integrante("Sandra", "Herrera", "A01798452@tec.mx", R.drawable.sandy)
)
